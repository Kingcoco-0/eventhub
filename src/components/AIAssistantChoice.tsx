...
import { ArrowLeft, MessageCircle, Wand2, Sparkles, Bot, Palette, Users, Calendar } from 'lucide-react';

interface AIAssistantChoiceProps {
  onBack: () => void;
  onChooseChat: () => void;
  onChooseImageInpainting: () => void;
}

const AIAssistantChoice: React.FC<AIAssistantChoiceProps> = ({ 
  onBack, 
  onChooseChat, 
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <p className="text-gray-400">Choose how you'd like AI to help you</p>
              </div>
            </div>
          </div>
        </div>
...
export default AIAssistantChoice;